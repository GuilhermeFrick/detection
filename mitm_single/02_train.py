"""
Treinamento do classificador MITM Single SOME/IP.

Uso:
    python mitm_single/02_train.py
"""
import sys, time
import numpy as np
...
if __name__ == '__main__':
    ...
    print('\n' + '='*50)
    print('  RESULTADOS -- MITM Single vs Benigno')
    print('='*50)
    ...
    path = MODEL_DIR / 'mitm_single_classifier.json'
